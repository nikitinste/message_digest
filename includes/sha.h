...
# define C sha->digest[2]
# define D sha->digest[3]
# define E sha->digest[4]
# define F sha->digest[5]
# define G sha->digest[6]
# define H sha->digest[7]
# define AA sha->digest_buf[0]
# define BB sha->digest_buf[1]
# define CC sha->digest_buf[2]
# define DD sha->digest_buf[3]
# define EE sha->digest_buf[4]
# define FF sha->digest_buf[5]
# define GG sha->digest_buf[6]
